...
import com.example.architecturepractice.customview.model.MonthCalendar
...
import com.example.architecturepractice.databinding.*
                    ...
                    if (eventStartDate != null && eventEndDate != null) {
                        ...
                        if (eventStartDate == curDateString && eventEndDate == afterDateString) {
                            ...
                            if(event.calendarId == koreanHolidayId) {
                                if(event.summary in koreanHoliday || event.summary?.contains(tmpHoliday) == true) {
                                    binding.dateNumberTextView.setTextColor(Color.RED)
                                }
                            }
                        }
